...
pvpfw_cleanup_abandondTimer = 720; // The vehicle will be removed after the specified time - 180 default
...
pvpfw_cleanUp_vehicleTimer = 900; //300
...
pvpfw_cleanUp_weaponHolderTimer = 900; // 300 Weaponholders will be deleted after this time

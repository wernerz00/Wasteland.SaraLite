...
[
	...
	["Vermin SMG", "SMG_01_F", 400]
];

rifleArray = compileFinal str
[
	// Underwater Gun
	["SDAR Underwater Rifle", "arifle_SDAR_F", 285],

	// Assault Rifles
	["Mk20 Carbine", "arifle_Mk20C_plain_F", 425],
	["Mk20 Carbine (Camo)", "arifle_Mk20C_F", 425],
	["Mk20 Rifle", "arifle_Mk20_plain_F", 550],
	["Mk20 Rifle (Camo)", "arifle_Mk20_F", 550],
	["Mk20 EGLM Rifle", "arifle_Mk20_GL_plain_F", 625],
	["Mk20 EGLM Rifle (Camo)", "arifle_Mk20_GL_F", 625],

	["TRG-20 Carbine", "arifle_TRG20_F", 400],
	["TRG-21 Rifle ", "arifle_TRG21_F", 475],
	["TRG-21 EGLM Rifle", "arifle_TRG21_GL_F", 500],

	["Katiba Carbine", "arifle_Katiba_C_F", 450],
	["Katiba Rifle", "arifle_Katiba_F", 575],
	["Katiba GL Rifle", "arifle_Katiba_GL_F", 700],

	["MX Carbine", "arifle_MXC_F", 450],
	["MX Carbine (Black)", "arifle_MXC_Black_F", 475],
	["MX Rifle", "arifle_MX_F", 550],
	["MX Rifle (Black)", "arifle_MX_Black_F", 600],
	["MX 3GL Rifle", "arifle_MX_GL_F", 750],
	["MX 3GL Rifle (Black)", "arifle_MX_GL_Black_F", 800],

	// Markman Rifles
	["MXM Rifle", "arifle_MXM_F", 900],
	["MXM Rifle (Black)", "arifle_MXM_Black_F", 925],
	["DMR Rifle", "srifle_DMR_01_F", 1000],
	["Mk18 ABR Rifle", "srifle_EBR_F", 1250],

	// DLC
	["Mk14 Rifle (Camo) [DLC]", "srifle_DMR_06_camo_F", 1450],
	["Mk14 Rifle (Olive) [DLC]", "srifle_DMR_06_olive_F", 1450],
	["Mk-I EMR Rifle [DLC]", "srifle_DMR_03_F", 1000],
	["Mk-I EMR Rifle (Camo) [DLC]", "srifle_DMR_03_multicam_F", 1000],
	["Mk-I EMR Rifle (Khaki) [DLC]", "srifle_DMR_03_khaki_F", 1000],
	["Mk-I EMR Rifle (Sand) [DLC]", "srifle_DMR_03_tan_F", 1000],
	["Mk-I EMR Rifle (Woodland) [DLC]", "srifle_DMR_03_woodland_F", 1000],
	["MAR-10 Rifle [DLC]", "srifle_DMR_02_F", 1500],
	["MAR-10 Rifle (Camo) [DLC]", "srifle_DMR_02_camo_F", 1500],
	["MAR-10 Rifle (Sand) [DLC]", "srifle_DMR_02_sniper_F", 1500],
	["Cyrus Rifle [DLC]", "srifle_DMR_05_blk_F", 1650],
	["Cyrus Rifle (Hex) [DLC]", "srifle_DMR_05_hex_F", 1650],
	["Cyrus Rifle (Tan) [DLC]", "srifle_DMR_05_tan_f", 1650],

	// Sniper Rifles
	["M320 LRR Sniper", "srifle_LRR_LRPS_F", 1450],
	...
	["ASP-1 Kir Rifle [DLC]", "srifle_DMR_04_F", 1350],
	["ASP-1 Kir Rifle (Tan) [DLC]", "srifle_DMR_04_tan_F", 1350]
];
...
[
	...
	["Mk200 LMG", "LMG_Mk200_F", 685],
	["Zafir LMG", "LMG_Zafir_F", 850],
	["Navid MMG (Tan) [DLC]", "MMG_01_tan_F", 900],
	["Navid MMG (Hex) [DLC]", "MMG_01_hex_F", 900],
	["SPMG MMG (Sand) [DLC]", "MMG_02_sand_F", 1000],
	["SPMG MMG (MTP) [DLC]", "MMG_02_camo_F", 1000],
...
[
	...
	["Mk30 HMG .50 High tripod (NATO)", "B_HMG_01_high_F", 2500],
	["Mk30 HMG .50 High tripod (CSAT)", "O_HMG_01_high_F", 2500],
	["Mk30 HMG .50 High tripod (AAF)", "I_HMG_01_high_F", 2500],
	...
	["Mk32 GMG 20mm High tripod (NATO)", "B_GMG_01_high_F", 2250],
	["Mk32 GMG 20mm High tripod (CSAT)", "O_GMG_01_high_F", 2250],
	["Mk32 GMG 20mm High tripod (AAF)", "I_GMG_01_high_F", 2250]
...
[
	...
	["Frag Grenade", "HandGrenade", 350],
	["APERS Tripwire Mine", "APERSTripMine_Wire_Mag", 300],
	["APERS Bounding Mine", "APERSBoundingMine_Range_Mag", 325],
...
[
	...
	["6.5mm 100Rnd Tracer (Red) Belt Case", "100Rnd_65x39_caseless_mag_Tracer", 175],
...
[
	...
	["Suppressor .338 [DLC]", "muzzle_snds_338_black", 300, "item"],
	["Suppressor .338 (Green) [DLC]", "muzzle_snds_338_green", 300, "item"],
	["Suppressor .338 (Sand) [DLC]", "muzzle_snds_338_sand", 350, "item"],
	["Suppressor 9.3mm [DLC]", "muzzle_snds_93mmg", 350, "item"],
	["Suppressor 9.3mm (Tan) [DLC]", "muzzle_snds_93mmg_tan", 3500, "item"],
	...
	["TWS", "optic_tws", 2750, "item"],
	["TWS MG", "optic_tws_mg", 2750, "item"],
...
[
	["Kart", "C_Kart_01_F", 800, "vehicle"],

	["Quadbike (Civilian)", "C_Quadbike_01_F", 350, "vehicle"],
	["Quadbike (NATO)", "B_Quadbike_01_F", 350, "vehicle"],
	["Quadbike (CSAT)", "O_Quadbike_01_F", 350, "vehicle"],
	["Quadbike (AAF)", "I_Quadbike_01_F", 350, "vehicle"],
	["Quadbike (FIA)", "B_G_Quadbike_01_F", 350, "vehicle"],

	["Hatchback", "C_Hatchback_01_F", 450, "vehicle"],
	["Hatchback Sport", "C_Hatchback_01_sport_F", 500, "vehicle"],
	["SUV", "C_SUV_01_F", 400, "vehicle"],
	["Offroad", "C_Offroad_01_F", 300, "vehicle"],
	["Offroad Camo", "B_G_Offroad_01_F", 350, "vehicle"],
	["Offroad Repair", "C_Offroad_01_repair_F", 400, "vehicle"],
	["Offroad HMG", "B_G_Offroad_01_armed_F", 450, "vehicle"],

	["Truck", "C_Van_01_transport_F", 150, "vehicle"],
	["Truck (Camo)", "B_G_Van_01_transport_F", 150, "vehicle"],
	["Truck Box", "C_Van_01_box_F", 200, "vehicle"],
	["Fuel Truck", "C_Van_01_fuel_F", 250, "vehicle"],
	["Fuel Truck (Camo)", "B_G_Van_01_fuel_F", 275, "vehicle"],

	["HEMTT Tractor", "B_Truck_01_mover_F", 300, "vehicle"],
	["HEMTT Box", "B_Truck_01_box_F", 300, "vehicle"],
	["HEMTT Transport", "B_Truck_01_transport_F", 300, "vehicle"],
	["HEMTT Covered", "B_Truck_01_covered_F", 300, "vehicle"],
	["HEMTT Fuel", "B_Truck_01_fuel_F", 4500, "vehicle"],
	["HEMTT Medical", "B_Truck_01_medical_F", 650, "vehicle"],
	["HEMTT Repair", "B_Truck_01_Repair_F", 850, "vehicle"],
	["HEMTT Ammo", "B_Truck_01_ammo_F", 1000, "vehicle"],

	["Tempest Device", "O_Truck_03_device_F", 1850, "vehicle"],
	["Tempest Transport", "O_Truck_03_transport_F", 500, "vehicle"],
	["Tempest Covered", "O_Truck_03_covered_F", 500, "vehicle"],
	["Tempest Fuel", "O_Truck_03_fuel_F", 750, "vehicle"],
	["Tempest Medical", "O_Truck_03_medical_F", 1750, "vehicle"],
	["Tempest Repair", "O_Truck_03_repair_F", 2500, "vehicle"],
	["Tempest Ammo", "O_Truck_03_ammo_F", 2250, "vehicle"],

	["Zamak Transport", "I_Truck_02_transport_F", 400, "vehicle"],
	["Zamak Covered", "I_Truck_02_covered_F", 400, "vehicle"],
	["Zamak Fuel", "I_Truck_02_fuel_F", 850, "vehicle"],
	["Zamak Medical", "I_Truck_02_medical_F", 950, "vehicle"],
	["Zamak Repair", "I_Truck_02_box_F", 1050, "vehicle"],
...
[
	...
	["Hunter GMG", "B_MRAP_01_gmg_F", 8000, "vehicle"],
	["Ifrit", "O_MRAP_02_F", 1500, "vehicle"],
	["Ifrit HMG", "O_MRAP_02_hmg_F", 7500, "vehicle"],
	["Ifrit GMG", "O_MRAP_02_gmg_F", 10000, "vehicle"],
	["Strider", "I_MRAP_03_F", 2500, "vehicle"],
	["Strider HMG", "I_MRAP_03_hmg_F", 6500, "vehicle"],
	["Strider GMG", "I_MRAP_03_gmg_F", 10500, "vehicle"],
	["MSE-3 Marid", "O_APC_Wheeled_02_rcws_F", 20000, "vehicle"],
...
[
	...
	["MH-9 Hummingbird", "B_Heli_Light_01_F", 1200, "vehicle"], // MH-6
	...
	["Mi-290 Taru (Bench) [DLC]", "O_Heli_Transport_04_bench_F", 1650, "vehicle"],
...
[
	...
	["MQ4A Greyhawk Missile UAV", "B_UAV_02_F", 45000, "vehicle"],
	["MQ4A Greyhawk Bomber UAV", "B_UAV_02_CAS_F", 35000, "vehicle"],
	["K40 Ababil-3 Missile UAV (CSAT)", "O_UAV_02_F", 45000, "vehicle"],
	["K40 Ababil-3 Bomber UAV (CSAT)", "O_UAV_02_CAS_F", 35000, "vehicle"],
	["K40 Ababil-3 Missile UAV (AAF)", "I_UAV_02_F", 45000, "vehicle"],
...
[
	[ // Main colors
		...
		[
			...
			//["Digital Lush", _texDir + "digi_lush.paa"],
			["Hex", _texDir + "hex.paa"],
			...
			//["I'm The Batman", _texDir + "bat.paa"],
...
[
	["H20 Shot", "water", localize "STR_WL_ShopDescriptions_Water", "client\icons\waterbottle.paa", 30, 15],
	["Snack Pack", "cannedfood", localize "STR_WL_ShopDescriptions_CanFood", "client\icons\cannedfood.paa", 30, 15],
	["Vehicle Pinlock", "pinlock", localize "STR_WL_ShopDescriptions_Pinlock", "client\icons\keypad.paa", 1000, 500],
	["Mechanic Kit", "repairkit", localize "STR_WL_ShopDescriptions_RepairKit", "client\icons\briefcase.paa", 500, 250],
	...
	["Beacon", "spawnbeacon", localize "STR_WL_ShopDescriptions_spawnBeacon", "client\icons\spawnbeacon.paa", 1500, 750],
